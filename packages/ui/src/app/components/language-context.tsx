...
const translations = {
  pt: {
    ...
    requestProjectAccess: "Solicitar acesso",
    requestProjectAccessDescription: "Se você for recrutador ou parte interessada, envie seu nome, e-mail e uma mensagem para pedir acesso sem alterar a senha do projeto.",
    requestProjectAccessDialogTitle: "Solicitar acesso ao projeto",
    requestProjectAccessDialogDescription: "Sua solicitação chegará por e-mail e também ficará disponível para aprovação no CMS.",
    submitAccessRequest: "Enviar solicitação",
    sendingAccessRequest: "Enviando solicitação...",
    accessRequestSent: "Solicitação enviada com sucesso!",
    accessRequestAlreadyPending: "Sua solicitação já foi enviada e está aguardando análise.",
    accessRequestDeniedNotice: "A solicitação anterior foi negada. Você pode enviar uma nova mensagem com mais contexto.",
    accessRequestEmailInvalid: "Informe um e-mail válido.",
    accessRequestNotificationWarning: "Solicitação salva, mas o e-mail de notificação não foi enviado.",
  ...
  en: {
    ...
    requestProjectAccess: "Request access",
    requestProjectAccessDescription: "If you are a recruiter or stakeholder, send your name, email, and a message to request access without changing the project password.",
    requestProjectAccessDialogTitle: "Request project access",
    requestProjectAccessDialogDescription: "Your request will be sent by email and will also be available for approval in the CMS.",
    submitAccessRequest: "Send request",
    sendingAccessRequest: "Sending request...",
    accessRequestSent: "Request sent successfully!",
    accessRequestAlreadyPending: "Your request has already been sent and is waiting for review.",
    accessRequestDeniedNotice: "The previous request was denied. You can send a new message with more context.",
    accessRequestEmailInvalid: "Enter a valid email address.",
    accessRequestNotificationWarning: "The request was saved, but the notification email could not be sent.",
