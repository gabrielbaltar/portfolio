import imgDJKoiGy3VBtw54S1EuF4UgDn8IEJpg from "figma:asset/a8a2910330eef4e894aef9565ddca1a5ca0a0df0.png";

function DJKoiGy3VBtw54S1EuF4UgDn8IEJpg() {
  return (
    <div className="absolute h-[525px] left-0 rounded-tl-[8px] rounded-tr-[8px] top-0 w-[700px]" data-name="dJKoiGy3vBtw54s1euF4UgDN8iE.jpg">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-tl-[8px] rounded-tr-[8px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgDJKoiGy3VBtw54S1EuF4UgDn8IEJpg} />
      </div>
    </div>
  );
}
...
function Image() {
  return (
    <div className="absolute h-[525px] left-0 overflow-clip top-0 w-[700px]" data-name="Image">
      <DJKoiGy3VBtw54S1EuF4UgDn8IEJpg />
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[20px] left-0 top-0 w-[642px]" data-name="Heading 3">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] left-0 not-italic text-[#fafafa] text-[16px] top-[10px] whitespace-nowrap">
        <p className="leading-[19.2px]">Automize</p>
      </div>
    </div>
  );
}
...
function Title() {
  return (
    <div className="absolute h-[25.456px] left-[16px] top-[12.86px] w-[671.728px]" data-name="Title">
      <Container2 />
...
function Container5() {
  return (
    <div className="absolute h-[20px] left-0 top-0 w-[668px]" data-name="Container">
      <a className="-translate-y-1/2 absolute flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] left-0 not-italic text-[#ababab] text-[0px] top-[10px] whitespace-nowrap" href="https://gbaltar.framer.website/work/automize">
        <p className="cursor-pointer leading-[19.6px] text-[14px]">AI Agency</p>
      </a>
    </div>
  );
}
