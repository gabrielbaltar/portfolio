import imgUlvReqxDHuFzobZf0AoTil4V8Jpg from "figma:asset/6152ef9e71bb7cd6e66a5a401a0c518b8b77fde7.png";

function UlvReqxDHuFzobZf0AoTil4V8Jpg() {
  return (
    <div className="absolute h-[525px] left-0 rounded-tl-[8px] rounded-tr-[8px] top-0 w-[700px]" data-name="ULVReqxDHuFzobZf0aoTil4V8.jpg">
