...
export function PortfolioHome() {
  ...
  const { profile, projects, experiences, education, certifications, stack, awards, recommendations, blogPosts } = data;
  ...
  return (
    ...
    >
      ...
      <Link
        to="/admin"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full px-4 py-2 shadow-lg backdrop-blur-md transition-all hover:scale-105"
        style={{
