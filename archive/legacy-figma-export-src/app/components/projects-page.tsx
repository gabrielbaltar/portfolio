          ...
          >
            <div className="flex items-center justify-between">
              <p
                ...
                style={{ fontSize: "16px", color: "var(--text-primary, #fafafa)" }}
              >
                {(project as any).password && (project as any).password.trim() !== "" && (
              ...
              <ArrowUpRight size={18} className="opacity-0 group-hover:opacity-100 transition-opacity" style={{ color: "var(--text-secondary, #ababab)" }} />
            </div>
            <p
