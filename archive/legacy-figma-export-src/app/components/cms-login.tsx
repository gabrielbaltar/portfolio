    ...
    >
      <div className="w-full max-w-[380px]">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-[#fafafa] mb-1" style={{ fontSize: "20px" }}>
            CMS Admin
          </h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-[#888] block" style={{ fontSize: "12px" }}>
              Email
            </label>
            <input
              type="email"
              ...
              className="w-full rounded-lg px-3.5 py-2.5 text-[#fafafa] placeholder-[#444] focus:outline-none transition-colors"
              style={{
                fontSize: "14px",
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full rounded-lg px-3.5 py-2.5 pr-10 text-[#fafafa] placeholder-[#444] focus:outline-none transition-colors"
                style={{
                  fontSize: "14px",
                  backgroundColor: "#141414",
                  border: "1px solid #242424",
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 rounded-lg py-2.5 text-[#111] cursor-pointer transition-all hover:opacity-90 disabled:opacity-50"
            style={{
              fontSize: "14px",
        ...
        <p className="text-center mt-6 text-[#444]" style={{ fontSize: "11px" }}>
